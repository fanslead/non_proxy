...
typedef struct _NP_WFP_UDP_DATAGRAM_V1 {
    UINT32 Magic;
    UINT16 Version;
    UINT16 HeaderSize;
    UINT32 TotalSize;
...
} NP_WFP_UDP_DATAGRAM_V1;

typedef struct _NP_WFP_UDP_INJECT_V1 {
    UINT32 Magic;
    UINT16 Version;
    UINT16 HeaderSize;
    UINT32 TotalSize;
...
C_ASSERT(FIELD_OFFSET(NP_WFP_UDP_BATCH_V1, Datagrams) == 16);
