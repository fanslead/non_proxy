...
#define NP_MAC_BRIDGE_ABI_VERSION 9u
...
int32_t np_mac_bridge_open_login_items_settings(void);
...
int32_t np_mac_bridge_list_applications(
    uint64_t operation_id,
    np_mac_bridge_callback callback,
    void *context);
...
int32_t np_mac_bridge_capture_current_network(
    uint64_t operation_id,
    np_mac_bridge_callback callback,
    void *context);
