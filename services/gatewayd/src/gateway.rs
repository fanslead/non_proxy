...
use crate::{
    ...
    event_hub::EventHub,
    outbound_group_selection_audit::OutboundGroupSelectionTracker,
...
pub struct Gateway {
    ...
    pub(crate) outbound_group_selections: OutboundGroupSelectionTracker,
    provider_health: ProviderHealthRegistry,
...
impl Gateway {
    ...
    pub(crate) fn new_with_system_policy(
        ...
        Self {
            ...
            outbound_group_selections: OutboundGroupSelectionTracker::default(),
