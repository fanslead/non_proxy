...
public sealed class WindowsReleaseSourceContractTests
{
    ...
    public void AdapterHostRemainsInPackageTrustAndLifecycleChain()
    {
        ...
        var sources = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["developmentInstall"] = Read(
                root,
                "Install-Development-Certificate.ps1"),
        ...
        foreach (var (source, required) in new[]
        {
            ...
            ("developmentSign", "$global:LASTEXITCODE = 0"),
            ...
            ("developmentInstall", "NonProxy-Development-Root.cer"),
            ("developmentInstall", "root-certificate-sha256.txt"),
